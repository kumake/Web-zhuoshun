...
<DIV id=wrap>
	<UL id=tags>
	  <LI class=selectTag style="LEFT: 0px; TOP: 0px"><A onfocus="this.blur()" onclick="selectTag('tagContent0',this)" href="javascript:void(0)">增加轮显广告</A></LI>
	</UL>
	<DIV id=tagContent>
	<DIV class="tagContent selectTag content" id=tagContent1>
		...
		<DIV>
			<TABLE cellSpacing="1" width="100%">
			  ...
			  <TR class="content-td1">
				<TD>广告元素一<span class="huitext">(图片,flash,文字)</span>：</TD>
				<TD>
				...
				<br>
				连接一：<input name="txt_adsurl" type="text" class="input" size="60"><span class="huitext">&nbsp;必填</span>
				<br>
				标题一：<input name="txt_adsurl" type="text" class="input" size="60"><span class="huitext">&nbsp;必填</span>
				</TD>
			  </TR>
			  ...
			  <TR class="content-td1">
				<TD>文件名称：</TD>
				<TD><input name="txt_starttime" type="text" class="input" ></TD>
			  </TR>
			  <TR class="content-td1">
				<TD>模板内容：</TD>
				<TD><textarea name="textarea" cols="80" rows="6"></textarea></TD>
			  </TR>
    		</TABLE>
		</DIV>
