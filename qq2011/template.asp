...
<DIV id=wrap>
	<UL id=tags>
	  <LI class=selectTag style="LEFT: 0px; TOP: 0px"><A onfocus="this.blur()" onclick="selectTag('tagContent0',this)" href="javascript:void(0)">选择模板</A></LI>
	</UL>
	<DIV id=tagContent>
			  ...
			  <%
				...
				Function ShowFolderList(folderspec)
					...
					For Each f1 in fd
					  ...
					  response.Write "<TD><img src='images/folder.gif' align='absmiddle'><a href='?obj="&obj&"&path=../Template/"&f1.name&"'>"&f1.name &"</a></TD>"
					...
					For Each f1 in fc
					  ...
					  response.Write "<TD align='center'><a href='javascript:selectTemplate(""/Template/"&Forderpath&"/"&f1.name&""");'>选择</a></TD>"
				      response.Write "</TR>"
					Next
					''''
					ShowFolderList = s
