...
*☆            QQ:589808                                             ☆
*★                                                                  ★
*☆  相关网址: [产品介绍]http://www.cqqzx.com/Product/eWebEditor/ ☆
*★            [支持论坛]http://bbs.enjoyfire.cn/                    ★
*☆                                                                  ☆
*★  主页地址: http://www.cqqzx.com/   eWebSoft团队及产品         ★
...
function document.onreadystatechange(){
	...
	if (!config.License){
		try{
			eWebEditor_License.innerHTML = "&copy; <a href='#' target='_blank'><font color=#000000>南京一优网络 </font></a>";
		}
		catch(e){
		}
	}
