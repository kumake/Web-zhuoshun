...
<%
	...
	if action<>"" and action="save" then
	  ...
	  if isCreateField="" then isCreateField = 0
		...
		''''
		Alert "增加字段成功","setting.sys.Field.expand.asp?tableID="&GroupID&""
	end if
%>
...
<DIV id=wrap>
	<UL id=tags>
	  <LI class=selectTag style="LEFT: 0px; TOP: 0px"><A onfocus="this.blur()" onclick="selectTag('tagContent0',this)" href="javascript:void(0)">增加系统表字段扩展</A></LI>
	</UL>
	<DIV id=tagContent>
