...
<%
	...
	if action<>"" and action="save" then
	  ...
	  if isNull ="" then isNull = 0
		...
		''''
		Alert "增加表单自定义字段成功","setting.selfform.Field.list.asp"
	end if
%>
...
<DIV id=wrap>
	<UL id=tags>
	  <LI class=selectTag style="LEFT: 0px; TOP: 0px"><A onfocus="this.blur()" onclick="selectTag('tagContent0',this)" href="javascript:void(0)">增加表单字段</A></LI>
	</UL>
	<DIV id=tagContent>
		...
		<DIV>
			<TABLE cellSpacing="1" width="100%">
			  <TR class="content-td1">
				...
				%>
				</select>&nbsp;<a href="setting.selfForm.add.asp">添加新的自定义表单</a>
				</TD>
			  </TR>
			  <TR class="content-td1">
				<TD>字段名称：</TD>
