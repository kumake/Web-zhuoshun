...
<%
	...
	if action<>"" and action="save" then 
		...
		'''''''增加记录
		Con.execute("insert into Sp_Job (departname,jobname,personnum,jobrequire,jobduty,validtime,isactive,IsOnlineDeliverResuem,[memo]) values ("&departname&",'"&jobname&"',"&personnum&",'"&jobrequire&"','"&jobduty&"','"&validtime&"',"&isactive&","&IsOnlineDeliverResuem&",'"&memo&"')")
		Alert "增加招聘岗位成功","pulg.job.list.asp"
	end if
%>
		...
		<DIV>
			<TABLE cellSpacing="1" width="100%">
			  <TR class="content-td1">
				...
				%>
				</select>&nbsp;<a href="setting.dictionary.add.asp?CategoryID=11">部门管理</a>
				</TD>
			  </TR>
			  <TR class="content-td1">
				<TD>岗位名称：</TD>
				<TD><input name="txt_jobname" type="text" class="input"><span class="huitext">&nbsp;必填</span></TD>
			  </TR>
			  <TR class="content-td1">
				<TD>招聘人数：</TD>
				<TD><input name="txt_personnum" type="text" class="input" value="1"><span class="huitext">&nbsp;必填</span></TD>
			  </TR>
			  <TR class="content-td1">
				<TD>岗位职责：</TD>
				<TD><textarea name="txt_jobduty" cols="60" rows="4"></textarea><span class="huitext">&nbsp;必填</span></TD>
			  </TR>
			  <TR class="content-td1">
				<TD>岗位需求：</TD>
				<TD><textarea name="txt_jobrequire" cols="60" rows="4"></textarea><span class="huitext">&nbsp;必填</span></TD>
			  </TR>
			  <TR class="content-td1">
				<TD>截止时间：</TD>
				<TD><input name="txt_validtime" type="text" class="input" onfocus="javascript:HS_setDate(this);"><span class="huitext">&nbsp;必填</span></TD>
			  </TR>			
			  <TR class="content-td1">
				<TD>是否在线投递简历：</TD>
				<TD><input name="txt_IsOnlineDeliverResuem" class="input" type="checkbox" value="1" checked></TD>
			  </TR>
			  <TR class="content-td1">
				<TD>是否显示：</TD>
			  ...
			  <TR class="content-td1">
				<TD>备注：</TD>
				<TD><textarea name="txt_memo" cols="60" rows="8" class="input"></textarea></TD>
			  </TR>
			</TABLE>
		</DIV>
		<div class="divpadding">
		  <input name="btnsearch" value="增加岗位" class="button" type="submit">
		</div>
	</DIV>
	</DIV>
</DIV>
